...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header { display: flex; justify-content: space-between; padding: 20px; border-bottom: 1px solid #eee; }
        .logo { color: #1a73e8; font-size: 20px; font-weight: bold; }
        .brand { font-size: 22px; font-weight: bold; color: #111; }

        .meta-row { display: flex; justify-content: space-between; padding: 16px 20px; }
        .emergency-label { font-size: 10px; color: #888; text-transform: uppercase; }
        .emergency-number { color: #e53e3e; font-size: 16px; font-weight: bold; }
        .emergency-note { font-size: 10px; color: #888; }

        .booking-ref-box { background: #1a3a5c; color: white; padding: 8px 16px; border-radius: 4px; font-size: 18px; font-weight: bold; text-align: center; }
        .airline-codes { font-size: 10px; color: #888; text-align: right; margin-top: 4px; }

        .passenger-bar { background: #f5f5f5; padding: 12px 20px; display: flex; align-items: center; gap: 12px; margin: 0 20px; border-radius: 4px; }
        .passenger-label { font-size: 10px; color: #888; text-transform: uppercase; }
        .passenger-name { font-size: 16px; font-weight: bold; color: #111; }
        ...
        .segment-header { display: flex; justify-content: space-between; padding: 10px 16px; background: #f9f9f9; border-bottom: 1px solid #ddd; font-weight: bold; font-size: 12px; }

        .segment-body { padding: 16px; }
        .flight-info-row { display: flex; justify-content: space-between; margin-bottom: 16px; }
        .airline-name { font-size: 15px; font-weight: bold; color: #1a3a5c; }
        .flight-sub { font-size: 11px; color: #555; margin-top: 2px; }

        .specs { text-align: right; }
        .spec-label { font-size: 9px; color: #888; text-transform: uppercase; }
        .spec-value { font-size: 11px; font-weight: bold; }

        .route-row { display: flex; align-items: center; justify-content: space-between; margin: 8px 0 16px; }
        .airport-code { font-size: 32px; font-weight: bold; color: #1a3a5c; }
        .airport-name { font-size: 11px; color: #555; }
        .terminal { font-size: 10px; color: #888; text-transform: uppercase; }
        .time { font-size: 18px; font-weight: bold; }
        .date-small { font-size: 11px; color: #555; }
        .duration { text-align: center; font-size: 11px; color: #555; border-top: 1px solid #ccc; padding-top: 4px; width: 100px; }

        .baggage-row { display: flex; justify-content: space-between; align-items: center; padding: 10px 16px; border-top: 1px solid #eee; background: #fafafa; }
        .baggage-item { display: flex; align-items: center; gap: 6px; }
        .baggage-label { font-size: 9px; color: #888; text-transform: uppercase; }
        .baggage-value { font-size: 12px; font-weight: bold; }
        .confirmed-badge { border: 2px solid #38a169; color: #38a169; padding: 4px 12px; border-radius: 20px; font-size: 11px; font-weight: bold; }

        .ticket-row { display: flex; gap: 40px; padding: 10px 16px; background: #fff8f0; border-top: 1px solid #eee; }
        .ticket-label { font-size: 9px; color: #888; text-transform: uppercase; }
        .ticket-value { font-size: 12px; font-weight: bold; color: #c05621; }
